...
PROJECT_DIR <- "C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds"
...
sites <- readRDS("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds/2_pipeline/1_CountDataProcessing/out/sites.RDS") ##actually stations...

sites <- sites%>% mutate(stationID = paste(siteID, station, sep = "-"))
```
...
d.buff2021 <- st_read("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds/0_data/sites2021_center.shp")
d.buffHist <- st_read("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds/0_data/historical_sites_centre.shp")
...
YG_extent <- st_read(file.path(gis_dir, "YG_SurfaceDisturbance_May2022/YG_SurfaceDisturbace_Extent_May2022.shp"))
YG_extent <- filter(YG_extent, YEAR_SUBMI > 2016) %>% st_union()## 2017 is start year of surveys, so use updates from that year onwards
sites <- sites %>%
  mutate(org = str_replace(organization, "WCSC", "WCS"))
...
saveRDS(sites.yr, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "sites_yr.RDS"))
...
saveRDS(wetland, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "wetlandPoly.RDS")) #polygon
saveRDS(fire, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "firePoly.RDS")) #polygon
saveRDS(landc.ls, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "landcPoly.RDS")) ## raster, cropped to site buffer
saveRDS(sites, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "sites_habpoly.RDS"))

p.dist <- read_rds(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "p.dist_p.rds"))
wetland <- readRDS(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "wetlandPoly.RDS"))
fire <- readRDS(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "firePoly.RDS"))
landc.ls<- readRDS(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "landcPoly.RDS"))
sites <- readRDS(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "sites_habpoly.RDS"))
sites.yr <- readRDS(file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "store", "sites_yr.RDS"))
...
#INSTEAD OF RERUNNING ABOVE I JUST DID THE BELOW
#add waterway to this from old run
...
##add daymet weather
hab.sum <- left_join(hab.sum, daymet%>%select(!year),by="siteID") 
...
```{r}
saveRDS(hab.sum, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "out", "hab_sum.RDS")) ## station level habitat summary
...
saveRDS(hab.sum, file.path("C:/Users/azeller/OneDrive - Wildlife Conservation Society/Documents/CE_birds",pipeline, "out", "hab_sum_site.RDS"))
